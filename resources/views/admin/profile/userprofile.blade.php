                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="last_name" class="form-control" autocomplete="off"
                                            autofocus="autofocus" value="{{ $user->last_name }}">
                                    </div>
                                    @error('last_name')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" class="form-control" autocomplete="off"
                                            autofocus="autofocus" value="{{ $user->phone }}">
                                    </div>
                                    @error('phone')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="photo" class="form-control dropify" autocomplete="off"
                                        autofocus="autofocus" data-default-file="{{ asset($user->photo) }}">
                                </div>
                            </div>
                        </div>
                </div>
